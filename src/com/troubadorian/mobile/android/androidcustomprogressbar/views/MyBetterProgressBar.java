package com.troubadorian.mobile.android.androidcustomprogressbar.views;

import java.util.ArrayList;

import com.troubadorian.mobile.android.androidcustomprogressbar.R;
...
public class MyBetterProgressBar extends LinearLayout implements Runnable
{
    ...
    public MyBetterProgressBar(Context context, AttributeSet attrs)
    {
        super(context, attrs);
    ...
    public MyBetterProgressBar(Context context)
    {
        super(context);
        this.context = context;
        prepareLayout();
...
//        imageHolders.add((ImageView) view.findViewById(R.id.imgThree));
        imageHolders.add((ImageView) view.findViewById(R.id.imgX));
    ...
    private Handler handler = new Handler()
    {
        ...
        public void handleMessage(Message msg)
        {
            ...
            for (ImageView imageView : imageHolders)
            {
                ...
                imageView.setImageResource(getResources().getIdentifier(images.get(nextImage - 1), "drawable", "com.beanie.example"));
            }
