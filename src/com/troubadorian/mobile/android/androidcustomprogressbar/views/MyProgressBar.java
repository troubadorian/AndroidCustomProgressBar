...
//        imageHolders.add((ImageView) view.findViewById(R.id.imgThree));
    ...
    private Handler handler = new Handler()
    {
        ...
        public void handleMessage(Message msg)
        {
            int currentImage = 0;
            int nextImage = 0;
            Log.d(TAG, "--------------------------------handleMessage(Message msg) was called");
            // Logic to change the images
            for (ImageView imageView : imageHolders)
            {
                Log.d(TAG, "=================wondering if thread enters this loop");
                ...
                imageView.setImageResource(getResources().getIdentifier(images.get(nextImage - 1), "drawable", "com.troubadorian.mobile.android.androidcustomprogressbar"));
            }
